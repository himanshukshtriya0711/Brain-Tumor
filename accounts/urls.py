...
from .views import (
    ...
    logout_view, appointments, book_appointment, cancel_appointment, prescriptions_view, process_scan, download_pdf
)
...
urlpatterns = [
    ...
    path('process_scan/', process_scan, name='process_scan'),  # Prediction API
